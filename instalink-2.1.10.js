...
InstaLinkWidget.prototype._templates = {
    ...
    post: "<a href=\"{$url}\" target=\"_blank\" class=\"instalink-feed-post\"> <span><img src=\"{$pic}\" alt=\"\" data-pic_orig=\"{$pic_orig}\"></span> </a>",
...
InstaLinkWidget.prototype._undusk = function() {
    ...
    $hiddenElements = self._structure.$root.parents('.instalink-preview').filter(function() {
...
InstaLinkWidget.prototype.updateFeed = function(append) {
    ...
    $.each(self._data.feed, function(i, item) {
        ...
        $post = $(self._compileTemplate("post", {
            url: item.link,
            pic: src,
            pic_orig: item.images.__original ? item.images.__original.url : item.images.standard_resolution.url
        }));
